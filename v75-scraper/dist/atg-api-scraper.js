...
export async function scrapeATGAPI() {
    let browser = null;
    try {
        ...
        const v75Data = await page.evaluate(() => {
            ...
            const dataElements = document.querySelectorAll('[data-testid*="race"], [data-testid*="horse"], [data-testid*="v75"]');
...
//# sourceMappingURL=atg-api-scraper.js.map