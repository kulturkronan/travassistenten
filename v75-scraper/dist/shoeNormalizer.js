 ...
 */
export function normalizeShoe(shoeText) {
    if (!shoeText)
        return undefined;
 ...
 * @returns Normaliserad skor-kombination eller undefined
 */
export async function extractShoeFromElement(element) {
    try {
        ...
        if (classNames) {
            ...
            const hasBarefootFront = classes.includes("barefoot") || classes.includes("barfota");
...
//# sourceMappingURL=shoeNormalizer.js.map